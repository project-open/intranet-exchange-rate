-- upgrade-5.1.0.0.1-5.2.0.0.0.sql

SELECT acs_log__debug('/packages/intranet-exchange-rate/sql/postgresql/upgrade/upgrade-5.1.0.0.1-5.2.0.0.0.sql','');


-- Compatibility version of fill_holes:
-- Fills holes for 2024 - 2028.
